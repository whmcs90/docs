...
<CardGroup cols={2}>
  ...
  {/* ✅ PERBAIKAN REPLAY BUTTON: Menggunakan 'square-plus' atau 'pointer' */}
  <Card
    title="Send Buttons"
    icon="pointer"
  ...
  {/* ✅ PERBAIKAN CTA BUTTONS: Menggunakan 'link' atau 'bolt' (aksi cepat) */}
  <Card
  ...
  {/* ✅ PERBAIKAN LIST MENU: Menggunakan 'list' atau 'bars' murni */}
  <Card
  ...
  {/* ✅ PERBAIKAN INTERACTIVE MESSAGE (POLLS): Menggunakan 'check-square' atau 'sliders' */}
  <Card
